...
function Footer() {
  return (
    <div className="continer border-top mt-5" >
      <div className="row mt-5">
        <div className="col">
          <img src="media/logo.svg" style={{ width: "45%" }} alt="logo" />
      ...
      <p>
        ...
        Risk Disclosure Document as prescribed by SEBI | ICF</p><p> Procedure to file a
        ...
        grievances </p><p>Smart Online Dispute Resolution | Grievances Redressal</p><p>
        Mechanism Investments in securities market are subject to market risks;
        read all the related documents carefully before investing.</p><p> Attention
        ...
        NSDL/CDSL every month.</p><p> "Prevent unauthorised transactions in your
